...
struct QuestionTests {
    ...
    private static func all(_ language: DummyLanguage) -> [ShellConfirmation] {
        [
            ...
            ShellQuestion.letGo(SpanSection.Ask(posts: 3, from: Date(), to: Date(), host: nil), language: language),
            ShellQuestion.letGo(SpanSection.Ask(posts: 1, from: Date(), to: Date(), host: "a.example"), language: language),
